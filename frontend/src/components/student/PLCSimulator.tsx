...
export function PLCSimulator() {
  ...
  const [lightIndicator, setLightIndicator] = useState(false);

  // PLC Logic: Motor enabled by Push Button 1; Light Indicator enabled by Push Button 2
  const motorEnabled = isPowerOn && pushButton1;
  const lightIndicatorEnabled = isPowerOn && pushButton2;
  ...
  const handlePushButton1Toggle = () => {
    if (isPowerOn) {
      const newState = !pushButton1;
      setPushButton1(newState);
      if (newState) {
        setMotor(true);
      }
    }
  ...
  const handlePushButton2Toggle = () => {
    if (isPowerOn) {
      const newState = !pushButton2;
      setPushButton2(newState);
      if (newState) {
  ...
  const handleLightIndicatorToggle = () => {
    if (lightIndicatorEnabled) {
      setLightIndicator(!lightIndicator);
    }
  };
            ...
            <div className="plc-io-items">
              ...
              <div className="plc-io-item">
                <div className="plc-io-indicator-wrapper">
                  <div
                    className={`plc-io-indicator ${pushButton1 ? "active" : "inactive"}`}
                  />
              ...
              <div className="plc-io-item">
                <div className="plc-io-indicator-wrapper">
                  <div
                    className={`plc-io-indicator ${pushButton2 ? "active" : "inactive"}`}
                  />
          ...
          <div className="plc-io-section">
            ...
            <div className="plc-io-items">
              ...
              <div className="plc-io-item">
                <div className="plc-io-indicator-wrapper">
                  <div
                    className={`plc-io-indicator output ${motor ? "active" : "inactive"}`}
                  />
                  <span className="plc-io-label">Motor</span>
                </div>
                <button
                  type="button"
                  className={`plc-io-status ${motor ? "active" : "inactive"}`}
              ...
              <div className="plc-io-item">
                <div className="plc-io-indicator-wrapper">
                  <div
                    className={`plc-io-indicator output ${lightIndicator ? "active" : "inactive"}`}
                  />
                  <span className="plc-io-label">Light Indicator</span>
                </div>
                <button
                  type="button"
                  className={`plc-io-status ${lightIndicator ? "active" : "inactive"}`}
                  onClick={handleLightIndicatorToggle}
                  disabled={!lightIndicatorEnabled}
                >
